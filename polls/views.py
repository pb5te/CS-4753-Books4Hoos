...
from polls.forms import Page


from polls.models import Question

from polls.models import Library
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            if user.is_active:
                ...
                login(request, user)
                return HttpResponseRedirect('/polls/store/')
            else:
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render_to_response('polls/add_category.html', {}, context)
...
def add_category(request):
    ...
    return render_to_response('polls/add_category.html', {'form': form}, context)
